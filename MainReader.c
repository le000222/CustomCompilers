...
* Function list: bErrorPrint(), displayBuffer(), getFileSize(), isNumber(), startReader(), mainReader()
************************************************************
*/
...
rid_void displayBuffer(BufferReader* ptr_Buffer);
rid_long getFileSize(rid_char* fname);
rid_int isNumber(const rid_char* ns);
rid_void startReader(rid_char*, rid_char*, rid_char, rid_int, rid_int);
...
rid_int mainReader(rid_int argc, rid_char** argv) {
	...
	rid_char* program = argv[0];
	rid_char* input = argv[2];
	rid_char mode = MODE_FIXED;
	rid_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
rid_void startReader(rid_char* program, rid_char* input, rid_char mode, rid_int size, rid_int increment) {
